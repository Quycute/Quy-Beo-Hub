--// dit con me may fix by nguyen minh nhat x ngo bao my
...
local NguyenNhatLoveNgoBaoMy = loadstring(game:HttpGet(('https://raw.githubusercontent.com/NguyenNhatSakura/NguyenNhatSakura/refs/heads/main/caigithenay/NguyenNhatLoveNgoBaoMy.lua')))()
local Window = NguyenNhatLoveNgoBaoMy:MakeWindow({Name = "Quy Beo Hub",IntroText = "Banana Library"})
...
function HopServer()
    ...
    v14.new("<Color=Red>Quy Beo Hub : Wait "..(tostring(Settings["Delay HopServer"]) or "15").."s[Hop Server]<Color=/>"):Display()
    while wait(Settings["Delay HopServer"] or 15) do
        local v14 = require(game:GetService("ReplicatedStorage").Notification)
        v14.new("<Color=Red>Quy Beo Hub : Hop Server<Color=/>"):Display()
        Hop()
    end
end
...
spawn(function()
    while task.wait() do
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Buso"].Value then
            pcall(function() 
...
spawn(function()
    while  task.wait() do
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Turn On Haki Observation"].Value then
            pcall(function() 
...
spawn(function()
    while  task.wait() do
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Turn On Race v4"].Value then
            pcall(function() 
...
spawn(function()
    loadstring([[
        ...
        oldSkill = hookfunction(require(game.ReplicatedStorage.Util).BodyMover.Create,function(p3,p4, p5)
            if p5.ID and env.NguyenNhatLoveNgoBaoMy.Flags["No Stun"].Value then
                p5.Duration = 0
            end
...
loadstring([[
    ...
    local Args = {...}
    if Method == 'FireServer' and self.Name == 'RemoteEvent' and getgenv().psskill and (getgenv().NguyenNhatLoveNgoBaoMy.Flags["Auto Mastery"].Value or getgenv().NguyenNhatLoveNgoBaoMy.Flags["Auto Seabeast"].Value or NguyenNhatLoveNgoBaoMy.Flags["Auto Aimbot"].Value or SeabeastAim or autospamskillTrial ) then
...
loadstring([[
    ...
    olddd = hookmetamethod(game, "__index", function(self, key)
        if tostring(key):lower()== 'hit' and getgenv().psskill and ((getgenv().NguyenNhatLoveNgoBaoMy.Flags["Select Method Mastery"].Value == "Gun" and getgenv().NguyenNhatLoveNgoBaoMy.Flags["Auto Mastery"].Value) or NguyenNhatLoveNgoBaoMy.Flags["Auto Aimbot"].Value) then
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Fast Attack"].Value then 
...
spawn(function()
    --[[while task.task.wait() do 
        pcall(function()
            if getgenv().StartAutoAttack  then
                autoattack()
                task.task.wait(NguyenNhatLoveNgoBaoMy.Flags["Select Speed Attack"].Value+0.02)
    ...
    game:GetService("RunService").RenderStepped:connect(function()
        if getgenv().StartAutoAttack  then
            autoattack()
            task.task.wait(NguyenNhatLoveNgoBaoMy.Flags["Select Speed Attack"].Value+0.01)
            getgenv().StartAutoAttack = false 
        end
    end)
end)
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Click"].Value  then
                autoattack()
            end
        end)
    end
...
function toTarget(pos, targetPos, targetCFrame,TpInstant)
    ...
    if (not NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value)  and (targetPos-pos).Magnitude >= 3000 and  NguyenNhatLoveNgoBaoMy.Flags["Reset Teleport"].Value and poscheckspawn(targetPos).Name ~= game:GetService("Players").LocalPlayer.Data.LastSpawnPoint.Value   then
        if getgenv().Tween then
            getgenv().Tween:Pause()
            getgenv().Tween:Cancel()
        end
        ...
        until poscheckspawn(targetPos).Name == game:GetService("Players").LocalPlayer.Data.LastSpawnPoint.Value or not NguyenNhatLoveNgoBaoMy.Flags["Reset Teleport"].Value
        plr.Character.Humanoid.Health = 0
        repeat task.wait()
    ...
    if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and plr.Character.Humanoid.Health > 0 then
        if (targetPos-pos).Magnitude <= 200 and not NguyenNhatLoveNgoBaoMy.Flags["Auto Chest"].Value  and not TpInstant then
            if getgenv().Tween then
                getgenv().Tween:Pause()
                getgenv().Tween:Cancel()
            end
...
function ToggleNoclip()
    if NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Elite Hunter"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Boss"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Dough King"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Citizen Quest"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Seabeast"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Soul Guitar"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Cursed Dual Katana"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Canvander"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Buddy Sword"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Yama"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Tushita"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Rip Indra"].Value
    or  NguyenNhatLoveNgoBaoMy.Flags["Auto Spawn Rip Indra"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Chest"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Get Blue Gear"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Pull Lever"].Value  
    or NguyenNhatLoveNgoBaoMy.Flags["Upgrade Race V2-V3"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Trial"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto New World"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Third Sea"].Value
    or NoclipButton  
    or NguyenNhatLoveNgoBaoMy.Flags["Dragon Talon"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Electric Claw"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value 
    or NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["SuperHuman"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Teleport Island"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Kill Player When complete Trial"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Find DF"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Next Island"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Teleport Mirage"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Farm Observation"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Factory"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Saber Sword"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Farm Select Mob"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Get Cyborg"].Value
    or NguyenNhatLoveNgoBaoMy.Flags["Auto Get Ghoul"].Value then
        return true 
    end
end
...
function equiptool(toolname,x)
    if not x then
        if  NguyenNhatLoveNgoBaoMy.Flags["Dragon Talon"].Value 
        or NguyenNhatLoveNgoBaoMy.Flags["Electric Claw"].Value 
        or NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value 
        or NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value
        or NguyenNhatLoveNgoBaoMy.Flags["SuperHuman"].Value then 
...
local TabMastery =  Tab:AddToggle({
    ...
    Flag = "Auto Mastery",
	Callback = function(Value)
        if not NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value and Value then 
            NguyenNhatLoveNgoBaoMy:MakeNotification({
                Name = "Quy Beo Hub",
...
function doublequestdeptrai()
    checkquest()
    local aa = {}
    if NguyenNhatLoveNgoBaoMy.Flags["Double Quest"].Value and checkquestdata() and  checknamedoublquest() == getgenv().mobv  and #checkdoublquest() >= 2 then
        for i,v in pairs(Quest) do
            for i1,v1 in pairs(v) do
                for i2,v2 in pairs(v1.Task) do
...
function checkskillMastery(x)
    for i,v in next,game:GetService("Players").LocalPlayer.PlayerGui.Main.Skills[x]:GetChildren() do 
        if v:IsA("Frame")  then
            if v.Name ~= "Template" and NguyenNhatLoveNgoBaoMy.Flags[v.Name].Value and v.Title.TextColor3 == Color3.new(1, 1, 1) and v.Cooldown.Size == UDim2.new(0, 0, 1, -1) or v.Cooldown.Size == UDim2.new(1, 0, 1, -1) then
                return v.Name
            end
        end
    end
...
function WeaponsMastery()
    ...
    for i,v in next,plr.Backpack:GetChildren() do
        if v:IsA("Tool") and v.ToolTip == NguyenNhatLoveNgoBaoMy.Flags["Select Method Mastery"].Value then
            a = v.Name 
        end
    end
...
function StopFarm()
    if NguyenNhatLoveNgoBaoMy.Flags["Find DF"].Value and GetPathFruit() then StartFarm = false return end
    if  CheckNameBoss("Core")  and game.PlaceId == 4442272183 and NguyenNhatLoveNgoBaoMy.Flags["Auto Factory"].Value then StartFarm = false  return  end
    if RaidStart then StartFarm = false return end
    if StopThirdSea() then StartFarm = false return end
    if game.PlaceId == 2753915549 and plr.Data.Level.Value >= 700 and NguyenNhatLoveNgoBaoMy.Flags["Auto New World"].Value then StartFarm = false return end
    if NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value and RaidCastleStart  then StartFarm = false  return end  
    if NguyenNhatLoveNgoBaoMy.Flags["Elite Hunter"].Value and DetectEliteHunter()  then StartFarm = false return  end  
    if EletrciClawStart then return end 
    if CheckNameBoss("rip_indra True Form [Lv. 5000] [Raid Boss]") and NguyenNhatLoveNgoBaoMy.Flags["Auto Rip Indra"].Value then  StartFarm = false return end
    if NguyenNhatLoveNgoBaoMy.Flags["Auto Spawn Rip Indra"].Value and ( plr.Backpack:FindFirstChild("God's Chalice") or  plr.Character:FindFirstChild("God's Chalice")) then StartFarm = false return end
    StartFarm = true
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value then 
                StopFarm()
            end
        end)
    end
...
function FarmMethod()
    ...
    local NameQuest 
    local IDQuest = 2
    if NguyenNhatLoveNgoBaoMy.Flags["Select Method Farm"].Value == "Farm Katakuri" then
        MethodFarm = MobKatakuri
        NameQuest = "CakeQuest2"
        LevelQuest = 2275
    elseif NguyenNhatLoveNgoBaoMy.Flags["Select Method Farm"].Value == "Farm Bones" then
    ...
    if MethodFarm then
        ...
        if  NguyenNhatLoveNgoBaoMy.Flags["Select Method Farm"].Value == "Farm Katakuri"  then 
            if CheckNameBoss("Cake Prince [Lv. 2300] [Raid Boss]")  then
                ...
                repeat task.wait()
                    ...
                    equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value
                return
            else
        ...
        if not DetectMob(MethodFarm) then 
            TeleportSpawnMob(MethodFarm, ( not StartFarm  or NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value))
        else
            ...
            repeat task.wait()
                ...
                sizepart(v)
                toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position,v.HumanoidRootPart.Position,v.HumanoidRootPart.CFrame*CFrame.new(7,20,0))
                if NguyenNhatLoveNgoBaoMy.Flags["Auto Mastery"].Value then
                    getgenv().psskill = v.HumanoidRootPart.CFrame
                    if v.Humanoid.Health / v.Humanoid.MaxHealth > NguyenNhatLoveNgoBaoMy.Flags["% Health Mob"].Value/100  then 
                        equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                    else
                        if NguyenNhatLoveNgoBaoMy.Flags["Select Method Mastery"].Value == "Gun" then 
            ...
            until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value or not StartFarm
        end
    else
                ...
                for i,v in next,game:GetService("Workspace").Characters:GetChildren() do
                    if v:IsA("Model") and v.Name == namequest then
                        repeat task.wait()
                            ...
                            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                            toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position,v.HumanoidRootPart.Position,v.HumanoidRootPart.CFrame*CFrame.new(7,20,0))
                        until not v or not v.Parent or v.Humanoid.Health <= 0 or not NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value or not plr.PlayerGui.Main:FindFirstChild("Quest").Visible or checksafezone(v) or StartFarm
                    end
                end
                return 
            end]]
        ...
        if not plr.PlayerGui.Main:FindFirstChild("Quest").Visible and typeof(MobLevelFarm) ==  "string" then
            ...
            if not DetectMob(MobLevelFarm) then
                TeleportSpawnMob(MobLevelFarm,(not StartFarm  or NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value))
            else
                    ...
                    if v.Name == "Ice Admiral [Lv. 700] [Boss]" then
                        if v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 then
                            repeat task.wait()
                                ...
                                equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                            until v.Humanoid.Health <= 0 or not NguyenNhatLoveNgoBaoMy.Flags["Auto New World"].Value 
                        end
                    end
                end
            end
...
function StopThirdSea()
    if NguyenNhatLoveNgoBaoMy.Flags["Auto Third Sea"].Value  and game.PlaceId == 4442272183 and plr.Data.Level.Value >= 1500 then
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 3 then
            ...
            if (NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value and  game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) == 3) 
            or (NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value and  game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 3)
            or (NguyenNhatLoveNgoBaoMy.Flags["Superhuman"].Value and  game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySuperhuman", true) ~= 1) then 
                return true
            end
            return 
        end
            ...
            if game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
                ...
                and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible  then
                    if not DetectMob("Swan Pirate [Lv. 775]") then 
                        TeleportSpawnMob("Swan Pirate [Lv. 775]",NguyenNhatLoveNgoBaoMy.Flags["Auto Third Sea"].Value)
                    else
                        ...
                        until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Auto Third Sea"].Value
                    end
                else
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto New World"].Value then 
                NewWorld()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Third Sea"].Value then 
                SeaThird()
            end
        end)
    end
...
function AutoEliteHunter()
    ...
    if CheckNameBoss("rip_indra True Form [Lv. 5000] [Raid Boss]") and NguyenNhatLoveNgoBaoMy.Flags["Auto Rip Indra"].Value then   return end
    if NguyenNhatLoveNgoBaoMy.Flags["Auto Spawn Rip Indra"].Value and ( plr.Backpack:FindFirstChild("God's Chalice") or  plr.Character:FindFirstChild("God's Chalice")) then  return end
    if  DetectEliteHunter() then 
        ...
        or not game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible then
            ...
            repeat task.wait()
                ...
                equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
            until not v or not v.Parent or v.Humanoid.Health == 0   or not NguyenNhatLoveNgoBaoMy.Flags["Elite Hunter"].Value or (NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value and DetectMobRaidCastle()) or RaidStart
        end
    else
        if NguyenNhatLoveNgoBaoMy.Flags["Hop Cup"].Value and not plr.Backpack:FindFirstChild("God's Chalice") and not plr.Character:FindFirstChild("God's Chalice") then
            HopServer()
        end
    end
end
...
function RaidCastle()
    ...
    if DetectMobRaidCastle() then
        ...
        repeat task.wait()
            ...
            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
        until not v or not v.Parent or v.Humanoid.Health == 0 or not NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value or RaidStart
    end
end
function Factory()
    ...
    if CheckNameBoss("Core") then 
        ...
        repeat task.wait()
            ...
            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
        until not v or not v.Parent or v.Humanoid.Health == 0 or not NguyenNhatLoveNgoBaoMy.Flags["Auto Factory"].Value or StopThirdSea() 
    end
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value then 
                if DetectMobRaidCastle() then 
                    ...
                    until tick()-timedelaya >= 20 or not NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value then 
                if NguyenNhatLoveNgoBaoMy.Flags["Find DF"].Value and GetPathFruit() then  return end
                RaidCastle()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function() 
            if NguyenNhatLoveNgoBaoMy.Flags["Elite Hunter"].Value then 
                if NguyenNhatLoveNgoBaoMy.Flags["Find DF"].Value and GetPathFruit() then  return end
                if NguyenNhatLoveNgoBaoMy.Flags["Raid Castle"].Value and RaidCastleStart then return end 
                AutoEliteHunter()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function() 
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Factory"].Value then 
                Factory()
            end
        end)
    end
...
function EquipSharkmanorDeadthstep()
    if not Tablefishmananddarkleg["darkleg"] and NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value  then 
    ...
    elseif not Tablefishmananddarkleg["fishman"] and NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value then 
...
function DeadthStepAndSharkman()
    if NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value and DetectKey("Library Key") 
    ...
    if NguyenNhatLoveNgoBaoMy.Flags["SuperHuman"].Value and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySuperhuman", true) == 1 then 
        if NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value and plr.Data.Fragments.Value >= 5000 and  game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) == 0 then
            game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySharkmanKarate", true)
            game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySharkmanKarate")
        elseif NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value and  plr.Data.Fragments.Value >= 5000 and  game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 0 then
    ...
    local namemob = (NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySharkmanKarate", true)  == 3 and CheckNameBoss("Tide Keeper [Lv. 1475] [Boss]")) or (NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value and  game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 3 and CheckNameBoss("Awakened Ice Admiral [Lv. 1400] [Boss]")) 
    if namemob then
        local v = namemob
        repeat task.wait()
            sizepart(v)
            ...
            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
        until v.Humanoid.Health <= 0  or not v or (v.Name == "Tide Keeper [Lv. 1475] [Boss]" and not NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value) or (v.Name == "Awakened Ice Admiral [Lv. 1400] [Boss]" and not NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value)  or RaidStart
    end
end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            ...
            elseif (NguyenNhatLoveNgoBaoMy.Flags["DeathStep"].Value and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyDeathStep", true) ~= 1) 
            or (NguyenNhatLoveNgoBaoMy.Flags["Sharkman Karate"].Value and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) ~= 1) then 
                EquipSharkmanorDeadthstep()
                DeadthStepAndSharkman()

            elseif NguyenNhatLoveNgoBaoMy.Flags["Electric Claw"].Value and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyElectricClaw", true)  ~= 1  then
                ElectricClaw()
            elseif NguyenNhatLoveNgoBaoMy.Flags["Dragon Talon"].Value and game.ReplicatedStorage.Remotes.CommF_:InvokeServer("BuyDragonTalon", true)  ~= 1 then 
                DragonTalon()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Boss"].Value then 
                local x = NguyenNhatLoveNgoBaoMy.Flags["Select Boss"].Value
                local a 
                local b
                if string.find(x,' %pRaid Boss%p') then
                    a = string.gsub(x,"%pLv. %d+%p", "")
                ...
                and NguyenNhatLoveNgoBaoMy.Flags["Get Quest Boss"].Value 
                and checkquestboss(NguyenNhatLoveNgoBaoMy.Flags["Select Boss"].Value) then
                    for i,v in pairs(Quest) do
                    ...
                    if CheckNameBoss(NguyenNhatLoveNgoBaoMy.Flags["Select Boss"].Value)  then
                        local v = CheckNameBoss(NguyenNhatLoveNgoBaoMy.Flags["Select Boss"].Value)
                        repeat task.wait()
                            sizepart(v)
                            toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position,v.HumanoidRootPart.Position,v.HumanoidRootPart.CFrame*CFrame.new(7,20,0))
                            if (plr.Character.HumanoidRootPart.Position-v.HumanoidRootPart.Position).Magnitude < 50 then
                            ...
                            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                        until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Auto Boss"].Value
                    end
                end
            end
        end)
...
function FarmMobSelect()
    if not DetectMob(TableSetectMob) then 
        TeleportSpawnMob(TableSetectMob,NguyenNhatLoveNgoBaoMy.Flags["Farm Select Mob"].Value)
    else
        ...
        until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Farm Select Mob"].Value
    end
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Farm Select Mob"].Value then 
                FarmMobSelect()
            end
        end)
    end
...
function FarmObservation()
    ...
    if not game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
        ...
        game:GetService("VirtualInputManager"):SendKeyEvent(false, "E", false, game)
        task.wait(3)
        if not game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and NguyenNhatLoveNgoBaoMy.Flags["Farm Observation [Hop]"].Value then 
            HopServer()
        end
    else
        if not mob then
            ...
            until not NguyenNhatLoveNgoBaoMy.Flags["Farm Observation"].Value or not game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
        end
    end
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Farm Observation"].Value then 
                FarmObservation()
            end
        end)
    end
...
Tab2:AddToggle({
	...
	Callback = function(Value)
        if Value then
            if NguyenNhatLoveNgoBaoMy.Flags["Tp Safe When Have God Chalice or Fist of Darkness"].Value then 
                NguyenNhatLoveNgoBaoMy:MakeNotification({
                    Name = "Quy Beo Hub",
...
function StartTeleportSafe()
    if NguyenNhatLoveNgoBaoMy.Flags["Tp Safe When Have God Chalice or Fist of Darkness"].Value 
...
function DoughKing()
    ...
    if CheckNameBoss("Cake Prince [Lv. 2300] [Raid Boss]") or CheckNameBoss("Dough King [Lv. 2300] [Raid Boss]") then
        ...
        repeat task.wait()
            ...
            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
        until not v or not v.Parent or v.Humanoid.Health == 0   or not NguyenNhatLoveNgoBaoMy.Flags["Auto Dough King"].Value
        return 
    end
    if not plr.Character:FindFirstChild("Sweet Chalice") and not plr.Backpack:FindFirstChild("Sweet Chalice") then
        if game.ReplicatedStorage.Remotes.CommF_:InvokeServer("SweetChaliceNpc")  == "Where are the items?"   then
            if not checkcountitem("Conjured Cocoa",10) then
                if not DetectMob(MobConjuredCocoa) then 
                    TeleportSpawnMob(MobConjuredCocoa,NguyenNhatLoveNgoBaoMy.Flags["Auto Dough King"].Value)
                else
                ...
                if not plr.Backpack:FindFirstChild("God's Chalice") and not plr.Character:FindFirstChild("God's Chalice") then
                    if DetectEliteHunter() then 
                        ...
                        if NguyenNhatLoveNgoBaoMy.Flags["Hop Cup"].Value then
                            HopServer()
                        end
                    end
                end
        ...
        if v204:find("open the portal now") then
            ...
            if not DetectMob(MobKatakuri) then 
                TeleportSpawnMob(MobKatakuri,NguyenNhatLoveNgoBaoMy.Flags["Auto Dough King"].Value)
            else
...
spawn(function()
    while task.wait() do 
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Dough King"].Value  then
            pcall(function()
                DoughKing()
            end)
        end
...
function CitizenQuestt()
    ...
    if not game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible then
        ...
        repeat task.wait()
            ...
            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
        until not v or not v.Parent or v.Humanoid.Health == 0   or not NguyenNhatLoveNgoBaoMy.Flags["Citizen Quest"].Value
    end
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Citizen Quest"].Value then 
                CitizenQuestt()
            end
        end)
    end
...
function checkseabeast()
    ...
    if NguyenNhatLoveNgoBaoMy.Flags["Auto PirateShip"].Value  then
        for i,v in next,game:GetService("Workspace").Enemies:GetChildren() do
...
function checkskillMelee()
    if not game:GetService("Players").LocalPlayer.PlayerGui.Main.Skills:FindFirstChild(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon SeaBeast 2"].Value)) then 
        equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon SeaBeast 2"].Value))
        return false
    end
    for i,v in next,game:GetService("Players").LocalPlayer.PlayerGui.Main.Skills[NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon SeaBeast 2"].Value)]:GetChildren() do 
        if v:IsA("Frame")  then
            if v.Name ~= "Template" and  NguyenNhatLoveNgoBaoMy.Flags["Seabeast2 "..v.Name].Value and v.Title.TextColor3 == Color3.new(1, 1, 1) and v.Cooldown.Size == UDim2.new(0, 0, 1, -1) or v.Cooldown.Size == UDim2.new(1, 0, 1, -1) then
                return v.Name
            end
        end
    end
...
function checkskillDF()
    if not game:GetService("Players").LocalPlayer.PlayerGui.Main.Skills:FindFirstChild(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon SeaBeast 1"].Value)) then 
        equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon SeaBeast 1"].Value))
        return false
    end
    for i,v in next,game:GetService("Players").LocalPlayer.PlayerGui.Main.Skills[NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon SeaBeast 1"].Value)]:GetChildren() do 
        if v:IsA("Frame")  then
            if v.Name ~= "Template" and NguyenNhatLoveNgoBaoMy.Flags["Seabeast1 "..v.Name].Value and v.Title.TextColor3 == Color3.new(1, 1, 1) and v.Cooldown.Size == UDim2.new(0, 0, 1, -1) or v.Cooldown.Size == UDim2.new(1, 0, 1, -1) then
                return v.Name
            end
        end
    end
...
function Seabeast()
    if not checkseabeast() then
        ...
        until not v or not v.Parent or v.Health.Value <= 0 or not NguyenNhatLoveNgoBaoMy.Flags["Auto Seabeast"].Value
    end
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Seabeast"].Value  then 
                if StartTeleportSafe() then 
                    return 
                end
                Seabeast()
...
function AutoRipIndra()
    ...
    if v then 
        repeat task.wait()
            ...
            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
        until not v or not v.Parent or v.Humanoid.Health == 0 or not NguyenNhatLoveNgoBaoMy.Flags["Auto Rip Indra"].Value
    else
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Spawn Rip Indra"].Value and ( plr.Backpack:FindFirstChild("God's Chalice") or  plr.Character:FindFirstChild("God's Chalice")) then
            if  not DetectButtons() then 
...
function AutoChest()
    ...
    until not v or not v.Parent or not NguyenNhatLoveNgoBaoMy.Flags["Auto Chest"].Value
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Chest"].Value  then 
                AutoChest()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Rip Indra"].Value  then 
                AutoRipIndra()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Buy Haki Color"].Value  then 
...
Tab3:AddToggle({
    ...
    Flag = "Hop Find DF",
	Callback = function(Value)
        if Value and not NguyenNhatLoveNgoBaoMy.Flags["Find DF"].Value then 
            NguyenNhatLoveNgoBaoMy:MakeNotification({
                Name = "Quy Beo Hub",
...
function HopFindDF()
    if GetPathFruit()  then
        ...
        if NguyenNhatLoveNgoBaoMy.Flags["Hop Find DF"].Value then
            HopServer()
        end
    end
end
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Find DF"].Value  then 
                HopFindDF()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Buy Random DF"].Value  then 
...
function StoreFruit(path)
    for i,v in pairs(path:GetChildren()) do
        if string.find(v.Name,"Fruit") and not v:FindFirstChild("Ignored")  then
            if NguyenNhatLoveNgoBaoMy.Flags["Webhook Store Fruit"].Value then
...
spawn(function()
    while task.wait() do
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Store"].Value then
            pcall(function()
                if NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value and DetectCountDF() then return end
...
function autobuydfshopp()
    for i,v in next,game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits", game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop:GetAttribute("Shop2")) do
        if v.Name == NguyenNhatLoveNgoBaoMy.Flags["Blox Fruit Sniper Shop"].Value then
            if v.OnSale then
                return v.Name 
            end
        end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Buy Blox Fruit Sniper Shop"].Value  then 
                if game:GetService("Players").LocalPlayer.Data.DevilFruit.Value == NguyenNhatLoveNgoBaoMy.Flags["Blox Fruit Sniper Shop"].Value and autobuydfshopp() then
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Esp Fruit"] then
                local v = GetEspFruit()
                if v then
                    ...
                    spawn(function()
                        ...
                        or not NguyenNhatLoveNgoBaoMy.Flags["Esp Fruit"].Value
                        Text:Remove()
                        if v then
                            Ignored:Destroy()
                        end
...
spawn(function()
    while task.wait() do
        if NguyenNhatLoveNgoBaoMy.Flags["Trade Bones"].Value then
            pcall(function()
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,1)
            end)
        end
...
spawn(function()
    while task.wait() do
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Awake"].Value then
            pcall(function()
                local args = {
                    [1] = "Awakener",
                    [2] = "Check"
...
function AutoRaids()
    if (NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value or NguyenNhatLoveNgoBaoMy.Flags["Auto Buy Chip"].Value) and getgenv().buychip  and plr.Data.Level.Value >= 1100  and not plr.PlayerGui.Main.Timer.Visible and not plr.Backpack:FindFirstChild("Special Microchip") and not plr.Character:FindFirstChild("Special Microchip") then
        if not checkdevilfruit()   and getfruitstore(true) and NguyenNhatLoveNgoBaoMy.Flags["Get Fruit In Store Low Beli"].Value and not NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value then 
        ...
        if #getbackpack() == 0 then
            ...
            game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaidsNpc", "Select",NguyenNhatLoveNgoBaoMy.Flags["Select Raid"].Value or "Flame")
        end
    end
    if (NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value or NguyenNhatLoveNgoBaoMy.Flags["Auto Start Raid"].Value) and (plr.Backpack:FindFirstChild("Special Microchip") or plr.Character:FindFirstChild("Special Microchip"))  then
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value then
            RaidStart2 = true
        end
    ...
    if (NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value or  NguyenNhatLoveNgoBaoMy.Flags["Auto Next Island"].Value) and plr.PlayerGui.Main.Timer.Visible then
    ...
    if (NguyenNhatLoveNgoBaoMy.Flags["Auto Raid and Find DF"].Value or  NguyenNhatLoveNgoBaoMy.Flags["Kill Aura Mob"].Value) and plr.PlayerGui.Main.Timer.Visible then
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Next Island"].Value 
            or NguyenNhatLoveNgoBaoMy.Flags["Auto Buy Chip"].Value
            or NguyenNhatLoveNgoBaoMy.Flags["Auto Start Raid"].Value
            or NguyenNhatLoveNgoBaoMy.Flags["Kill Aura Mob"].Value then 
                AutoRaids()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        if NguyenNhatLoveNgoBaoMy.Flags["Webhook Server Full Moon Or Next Night"].Value then 
            pcall(function()
...
spawn(function()
    while task.wait() do 
        if NguyenNhatLoveNgoBaoMy.Flags["Webhook Mirage"].Value then 
            pcall(function()
...
Tab5:AddToggle({
	...
	Callback = function(Value)
        if Value then
            if not NguyenNhatLoveNgoBaoMy.Flags["Auto Farm"].Value then
                NguyenNhatLoveNgoBaoMy:MakeNotification({
                    Name = "Quy Beo Hub",
                    Content = "Turn On Auto Farm, Please",
                    Image = "rbxassetid://4483345998",
...
Tab5:AddToggle({
	...
	Callback = function(Value)
        if not NguyenNhatLoveNgoBaoMy.Flags["Auto Buy Legend Sword"].Value and Value then 
            NguyenNhatLoveNgoBaoMy:MakeNotification({
                Name = "Quy Beo Hub",
    ...
    if not checkcountitem("Dark Fragment",1)  then
            ...
            if CheckNameBoss("Darkbeard [Lv. 1000] [Raid Boss]") then 
                ...
                if  plr.Character:FindFirstChild("Fist of Darkness") or plr.Backpack:FindFirstChild("Fist of Darkness") then
                    ...
                    repeat task.wait()
                        ...
                        toTarget(game.Players.LocalPlayer.Character.HumanoidRootPart.Position,v.Position,v.CFrame*CFrame.new(0,1,0),true)
                    until not v or not v.Parent or not NguyenNhatLoveNgoBaoMy.Flags["Soul Guitar"].Value
                end
            end
        else
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
        ...
        if game.PlaceId == PlaceId then 
            if not DetectMob(Mob) then 
                TeleportSpawnMob(Mob,NguyenNhatLoveNgoBaoMy.Flags["Soul Guitar"].Value)
            else
                ...
                until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Soul Guitar"].Value
            end
        else
        ...
        if not CheckNameBoss("Soul Reaper [Lv. 2100] [Raid Boss]") then
            if not plr.Character:FindFirstChild("Hallow Essence") and not plr.Backpack:FindFirstChild("Hallow Essence") then
                if not DetectMob(TableMobBones) then 
                    TeleportSpawnMob(TableMobBones,NguyenNhatLoveNgoBaoMy.Flags["Cursed Dual Katana"].Value)
                else
                    ...
                    until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Cursed Dual Katana"].Value
                end
            else
...
function GetYama()
    if game.ReplicatedStorage.Remotes.CommF_:InvokeServer("EliteHunter", "Progress") < 30 then 
        if not NguyenNhatLoveNgoBaoMy.Flags["Elite Hunter"].Value  then 
            NguyenNhatLoveNgoBaoMy:MakeNotification({
                Name = "Quy Beo Hub",
...
function MultiGetItem()
    local namemob = {}
    if NguyenNhatLoveNgoBaoMy.Flags["Canvander"].Value then 
        table.insert(namemob,"Beautiful Pirate [Lv. 1950] [Boss]")
    end
    if NguyenNhatLoveNgoBaoMy.Flags["Buddy Sword"].Value then 
        table.insert(namemob,"Cake Queen [Lv. 2175] [Boss]")
    end
    if NguyenNhatLoveNgoBaoMy.Flags["Pole Sword"].Value then 
                    ...
                    elseif game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon") == 0 then
                        ...
                        if v then
                            repeat task.wait()
                                ...
                                equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                            until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Saber Sword"].Value
                        end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Saber Sword"].Value  then 
                SaberSword()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Soul Guitar"].Value  then 
                AutoSoulGuitar()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Cursed Dual Katana"].Value  then 
                GetCDK()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Yama"].Value  then 
                GetYama()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Tushita"].Value  then 
                GetTushita()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Buy Legend Sword"].Value  then 
                local args = {
                    [1] = "LegendarySwordDealer",
                    [2] = "2"
                }
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                if NguyenNhatLoveNgoBaoMy.Flags["Auto Buy Legend Sword [ Hop ]"].Value then 
                    HopServer()
                end
            end
        end)
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Unlock All Skill Sword In Inventory"].Value  then
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Canvander"].Value or  NguyenNhatLoveNgoBaoMy.Flags["Buddy Sword"].Value then 
                MultiGetItem()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Esp Player"].Value then 
                local v = GetPlayer()
                if v then
                    ...
                    spawn(function()
                        ...
                        or not NguyenNhatLoveNgoBaoMy.Flags["Esp Player"].Value
                        Text:Remove()
                        if v then
                            Ignored:Destroy()
                        end
    ...
    for i,v in pairs(game.Workspace.Characters:GetChildren()) do
        if v:IsA("Model")  then
            if v.Name ~= plr.Name and (game.Players.LocalPlayer.Team == game.Teams.Marines and game.Players[v.Name].Team ~= game.Teams.Marines or game.Players.LocalPlayer.Team ~= game.Teams.Marines)  then
                if NguyenNhatLoveNgoBaoMy.Flags["Select Method Aimbot"].Value == "Target nearest Player" then
                    ...
                    if Distance <= NguyenNhatLoveNgoBaoMy.Flags["POV SIZE"].Value then
                        dist = Distance
                        Closest = v
                    end
                end
...
spawn(function()
    while task.wait() do
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Aimbot"].Value and NguyenNhatLoveNgoBaoMy.Flags["Select Method Aimbot"].Value == "FOV Mouse" then 
...
game:GetService("RunService").RenderStepped:connect(function()
    pcall(function()
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Aimbot"].Value then 
            if NguyenNhatLoveNgoBaoMy.Flags["Select Method Aimbot"].Value == "Select Player" then 
                local v = game.Workspace.Characters[NguyenNhatLoveNgoBaoMy.Flags["Select Player Target"].Value]
        ...
        if CheckNameBoss("Order [Lv. 1250] [Raid Boss]") then
            ...
            if v then
                repeat task.wait()
                    ...
                    equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Auto Get Cyborg"].Value
            end
        else
        ...
        if CheckNameBoss("Cursed Captain [Lv. 1325] [Raid Boss]") then
            ...
            if v then
                repeat task.wait()
                    ...
                    equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
                until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Auto Get Ghoul"].Value
                task.wait(2)
            end
        else
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Get Ghoul [ Hop Find Boss ]"].Value then 
                HopServer()
            end
        end
    end
...
function RaceHumanV2()
    ...
    if DetectbossHuman then 
        ...
        repeat task.wait()
            ...
            equiptool(NameWeapon(NguyenNhatLoveNgoBaoMy.Flags["Select Weapon"].Value))
        until not v or not v.Parent or v.Humanoid.Health == 0  or not NguyenNhatLoveNgoBaoMy.Flags["Upgrade Race V2-V3"].Value
...
function MinkHumanV2()
    ...
    repeat task.wait()
        ...
        toTarget(game.Players.LocalPlayer.Character.HumanoidRootPart.Position,v.Position,v.CFrame*CFrame.new(0,1,0),true)
    until not v or not v.Parent or not NguyenNhatLoveNgoBaoMy.Flags["Upgrade Race V2-V3"].Value
end
    ...
    if string.find(Race,"V1") then 
        ...
        elseif game.ReplicatedStorage.Remotes.CommF_:InvokeServer("Alchemist", "1") == 1 then
            ...
            elseif not CheckItemInChar("Flower 3") then 
                print("c")
                if not DetectMob("Swan Pirate [Lv. 775]") then 
                    TeleportSpawnMob("Swan Pirate [Lv. 775]",NguyenNhatLoveNgoBaoMy.Flags["Upgrade Race V2-V3"].Value)
                else
                    local v = DetectMob("Swan Pirate [Lv. 775]")
                    repeat task.wait()
                        sizepart(v)
        ...
        elseif Race == "Fishman V2" then
            if not checkseabeast() then
                ...
                until not v or not v.Parent or v.Health.Value <= 0 or not NguyenNhatLoveNgoBaoMy.Flags["Upgrade Race V2-V3"].Value
                SeabeastAim = false
            end
        else
            NguyenNhatLoveNgoBaoMy:MakeNotification({
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Upgrade Race V2-V3"].Value then 
                UpgradeRace()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Get Cyborg"].Value then 
                GetCyborg()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Get Ghoul"].Value then 
                GetGhoul()
            end
        end)
    end
...
Tab9:AddToggle({
    ...
    Flag = "Pull Lever [ Hop ]",
	Callback = function(Value)
        if not NguyenNhatLoveNgoBaoMy.Flags["Pull Lever"].Value and Value then 
            NguyenNhatLoveNgoBaoMy:MakeNotification({
                Name = "Quy Beo Hub",
...
Tab9:AddToggle({
    ...
    Flag = "Auto Trial [ Hop ]",
	Callback = function(Value)
        if not NguyenNhatLoveNgoBaoMy.Flags["Auto Trial"].Value and Value then 
            NguyenNhatLoveNgoBaoMy:MakeNotification({
                Name = "Quy Beo Hub",
...
function AutoTrials()
    if  (CheckMoon() == "Full Moon"  or CheckMoon() == "Next Night")   and NguyenNhatLoveNgoBaoMy.Flags["Auto Trial [ Hop ]"].Value  then 
        NguyenNhatLoveNgoBaoMy:MakeNotification({
            Name = "Quy Beo Hub",
        ...
        if NguyenNhatLoveNgoBaoMy.Flags["Auto Trial [ Hop ]"].Value then 
            HopServer()
            return 
        end
    end
    ...
    if game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible then
        ...
        if not TrialDone and not game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible   then 
            local Door = game:GetService("Workspace").Map["Temple of Time"][game.Players.LocalPlayer.Data.Race.Value.."Corridor"].Door.Door.RightDoor.Union
            toTarget(plr.Character.HumanoidRootPart.Position,Door.Position,Door.CFrame)
            if NguyenNhatLoveNgoBaoMy.Flags["Detect Players When Turn Race V3 And Auto Turn On Race V3"].Value  and  CheckMultiTeleDoor() then 
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Trial"].Value then 
                AutoTrials()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Kill Player When complete Trial"].Value then 
                AutoKilPlayer()
            end
        end)
    end
...
task.spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Kill Player When complete Trial"].Value and KillAuraDone and game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible then 
                autoattack()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Get Blue Gear"].Value then 
                CollectBlueGear()
            end
        end)
    end
...
function PullLever()
    if not game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("CheckTempleDoor") then 
        ...
        elseif game:GetService("Workspace").Map:FindFirstChild("MysticIsland") and function7() ~= "Night" then 
            ...
            task.wait(5)
        elseif not game:GetService("Workspace").Map:FindFirstChild("MysticIsland") and NguyenNhatLoveNgoBaoMy.Flags["Pull Lever [ Hop ]"].Value then 
            HopServer()
        end
    else
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Pull Lever"].Value then 
                PullLever()
            end
        end)
    end
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Buy Gear"].Value then 
...
spawn(function()
    while task.wait() do 
        pcall(function()
            if NguyenNhatLoveNgoBaoMy.Flags["Auto Choose Gears"].Value then 
...
spawn(function()
    while task.wait() do
        if NguyenNhatLoveNgoBaoMy.Flags["White Screen"].Value then
            pcall(function()
...
spawn(function()
    while task.wait() do 
        if NguyenNhatLoveNgoBaoMy.Flags["Teleport Island"].Value then 
            pcall(function()
                for i,v in next,Island do
                    if i == NguyenNhatLoveNgoBaoMy.Flags["Select Island"].Value then
...
spawn(function()
    while task.wait() do 
        if NguyenNhatLoveNgoBaoMy.Flags["Teleport Mirage"].Value then 
            pcall(function()
                if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
                    ...
                    for i, v in pairs(AllNPCS) do
                        if v.Name == "Advanced Fruit Dealer" then
                            repeat task.wait()
                                toTarget(plr.Character.HumanoidRootPart.Position,v.HumanoidRootPart.Position,v.HumanoidRootPart.CFrame)
                            until (v.HumanoidRootPart.Position-plr.Character.HumanoidRootPart.Position).Magnitude < 8 or not NguyenNhatLoveNgoBaoMy.Flags["Teleport Mirage"].Value
                        end
                    end
                end
            end)
    ...
    while task.wait() do 
        pcall(function()
            for i,v in next,tablestats do 
                if NguyenNhatLoveNgoBaoMy.Flags["Stats "..i].Value and game.Players.localPlayer.Data.Points.Value > 0 and game:GetService("Players").LocalPlayer.Data.Stats[i].Level.Value < 2450 then
